...
const SITE_URL = isClawds() ? `https://${brand.domain}` : CDN_URL

const CDN_ASSETS = {
    LOGO: isClawds()
        ? `${SITE_URL}/assets/clawds-logo.png`
        : `${CDN_URL}/assets/clawhost-logo.png`,
    LOGO_DARK: isClawds()
        ? `${SITE_URL}/assets/clawds-logo-dark.png`
        : `${CDN_URL}/assets/clawhost-logo-dark.png`,
    LOGO_LIGHT: isClawds()
        ? `${SITE_URL}/assets/clawds-logo-light.png`
