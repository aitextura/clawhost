...
async function createProducts() {
    ...
    const tiers = [
        { dbKey: 'stripe_price_tier_starter', name: 'Clawds Starter', price: 2000, desc: 'Your own AI agent on a dedicated VPS. Pre-configured with OpenClaw, Chrome browser, hardened security, SSL, and all integrations ready to go.' },
        { dbKey: 'stripe_price_tier_pro', name: 'Clawds Pro', price: 6500, desc: 'Powerful AI agent with SSH access, sub-agent spawning, scheduled tasks, and semantic memory. Everything in Starter, with more resources.' },
        { dbKey: 'stripe_price_tier_business', name: 'Clawds Business', price: 19500, desc: 'Enterprise-grade AI agent with maximum resources, priority support, and advanced security. Everything in Pro, scaled for teams.' }
    ]
